...
#Vamos considerar a variância original e a multiplicação da variância 2 e 4 vezes
...
cat("
    ...
    # Prior - usa a precisao ao invés da variância - a precisao é o inverso da variancia
...
#Vamos considerar a variância original e a multiplicacao da variância 2 e 4 vezes
